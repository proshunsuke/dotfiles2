...
local["^https://voyagegroup.slack.com/"] = [
    // jump
    pass(["g", "h"]),
    pass(["g", "a"]),
    pass(["g", "s"]),
...
key.setGlobalKey(['C-x', 'o'], function (ev, arg) {
    ...
    function findLayoutByTab(tab) {
        ...
        for (i = 0; i < tileTabs.layouts.length; i++) {
            if (tileTabs.layouts[i].layoutID == tab.getAttribute("tiletabs-assigned")) return tileTabs.layouts[i];
        }
        return null;
    }
